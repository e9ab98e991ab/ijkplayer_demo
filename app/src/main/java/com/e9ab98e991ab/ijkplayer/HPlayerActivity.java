...
public class HPlayerActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rootView = LayoutInflater.from(this).inflate(R.layout.activity_h, null);
        ...
        String url1 = getLocalVideoPath("test_video.mp4");
        if (!new File(url1).exists()) {
            url1 = "http://img.61gequ.com/media/mp4/yufuhetadeqizi_800_450.mp4";
        }
        String url2 = "http://img.61gequ.com/media/mp4/yufuhetadeqizi_800_450.mp4";
            ...
            public PlayerView setPlaySource(List<VideoijkBean> list) {
                ...
                .showThumbnail(new OnShowThumbnailListener() {
                    ...
                    public void onShowThumbnail(ImageView ivThumbnail) {
                        Glide.with(HPlayerActivity.this)
